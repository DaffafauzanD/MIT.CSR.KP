...
function editPengajuanUlangDetailSave() {
    ...
    ConfirmMessage('Apakah Anda Yakin?', async isConfirm => {
        if (isConfirm) {
            ...
            var param = {
                Deskripsi: $('#Detail-PengajuanUlang-Comment').val(),
                Lampiran: [
                    {
            ...
            RequestData('PUT', `/v1/Penawaran/edit/${id}`, '#DetailPengajuan', null, JSON.stringify(param), function (data_obj) {
