                        ...
                        if (item.Progress >= 100) {
                            ...
                            $('#btnClose').append(`
                                <div class="col mx-3 border border-dark border-2 rounded-2">
                                    <div class="row mt-2">
                                        <div class="col">
                                            <h6>Progress telah mencapai 100% segera setujui closing</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-auto my-2 ">
                                        <label>Lampiran Dokumen BAST</label>
                                    </div>
                                    <div class="col-12 text-end m-3 me-3 pe-3">
                                        <button class="btn-primary" type="button" onClick="ApproveCloseProgramDialog(this);">Tindakan</button>
                                    </div>
                                </div>
                            `);
                        }
...
function ApproveCloseProgramDialog() {
    $('#modalApproveCloseProgress-monitoring').modal('show');
    getListItemKebutuhan();
}
