$(document).ready(function () {
    ...
    ListDati("#Penawaran-Kegiatan-Container", null, true);
    $('#Penawaran-JenisProgram').on('change', function () {
        ...
        var booleaneks = false;
        if ($(this).val() == "") {
            parameks = null;
            booleaneks = true;
        }

        ListKegiatanReferensi('#Penawaran-Kegiatan-Container', '#Penawaran-Kegiatan', null, booleaneks, parameks);
    });
    ListPenawaran();
});
                    ...
                    data.list.forEach(function (item) {
                        ...
                        $(element.tbody).append(`
                                  <tr>
                                        ...
                                        <td class="text-center">${item.waitingPenawaran}</td>
