...
{
    public class GetPenawaranListRequest : ListRequest,IListRequest<GetPenawaranListRequest>,IRequest<ListResponse<PenawaranResponse>>
    {
    }
    internal class GetPenawaranListHandler : IRequestHandler<GetPenawaranListRequest, ListResponse<PenawaranResponse>>
    {
        ...
        public async Task<ListResponse<PenawaranResponse>> Handle(GetPenawaranListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<MIT.ECSR.Data.Model.TrsPenawaran>().AsQueryable();

				#region Filter
				Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, object>> column_sort = null;
				List<Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, bool>>> where = new List<Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, bool>>>();
				...
				result.List = _mapper.Map<List<PenawaranResponse>>(data_list);
        ...
        #region List Utility
		private (Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, bool>> where, Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, object>> result_order = null;
			Expression<Func<MIT.ECSR.Data.Model.TrsPenawaran, bool>> result_where = null;
