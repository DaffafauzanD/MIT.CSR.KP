...
{
    public class GetOpdListRequest : ListRequest,IListRequest<GetOpdListRequest>,IRequest<ListResponse<OpdResponse>>
    {
    }
    internal class GetOpdListHandler : IRequestHandler<GetOpdListRequest, ListResponse<OpdResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetOpdListHandler(
            ILogger<GetOpdListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<OpdResponse>> Handle(GetOpdListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<OpdResponse> result = new ListResponse<OpdResponse>();
            try
            {
				var query = _context.Entity<MIT.ECSR.Data.Model.RefOpd>().AsQueryable();

				#region Filter
				Expression<Func<MIT.ECSR.Data.Model.RefOpd, object>> column_sort = null;
				List<Expression<Func<MIT.ECSR.Data.Model.RefOpd, bool>>> where = new List<Expression<Func<MIT.ECSR.Data.Model.RefOpd, bool>>>();
				...
				result.List = _mapper.Map<List<OpdResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List Opd", request);
                result.Error("Failed Get List Opd", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<MIT.ECSR.Data.Model.RefOpd, bool>> where, Expression<Func<MIT.ECSR.Data.Model.RefOpd, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<MIT.ECSR.Data.Model.RefOpd, object>> result_order = null;
			Expression<Func<MIT.ECSR.Data.Model.RefOpd, bool>> result_where = null;
