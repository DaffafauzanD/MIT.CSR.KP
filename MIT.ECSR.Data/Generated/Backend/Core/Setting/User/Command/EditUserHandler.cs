...
namespace MIT.ECSR.Core.User.Command
{
    ...
    public class EditUserRequest :UserRequest, IMapRequest<MIT.ECSR.Data.Model.SetUser, EditUserRequest>,IRequest<StatusResponse>
    {
        [Required]
        public Guid Id { get; set; }
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<EditUserRequest, MIT.ECSR.Data.Model.SetUser> map)
        {
    ...
    internal class EditUserHandler : IRequestHandler<EditUserRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(EditUserRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var existingItems = await _context.Entity<MIT.ECSR.Data.Model.SetUser>().Where(d => d.Id == request.Id).FirstOrDefaultAsync();
