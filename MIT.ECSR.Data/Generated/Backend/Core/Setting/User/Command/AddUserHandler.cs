...
namespace MIT.ECSR.Core.User.Command
{
    ...
    public class AddUserRequest :UserRequest, IMapRequest<MIT.ECSR.Data.Model.SetUser, AddUserRequest>,IRequest<StatusResponse>
    {
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<AddUserRequest, MIT.ECSR.Data.Model.SetUser> map)
        {
    ...
    internal class AddUserHandler : IRequestHandler<AddUserRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddUserRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<MIT.ECSR.Data.Model.SetUser>(request);
