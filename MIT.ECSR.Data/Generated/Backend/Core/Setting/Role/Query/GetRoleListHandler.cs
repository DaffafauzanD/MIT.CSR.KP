...
namespace MIT.ECSR.Core.Role.Query
{
    ...
    internal class GetRoleListHandler : IRequestHandler<GetRoleListRequest, ListResponse<RoleResponse>>
    {
        ...
        public async Task<ListResponse<RoleResponse>> Handle(GetRoleListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<MIT.ECSR.Data.Model.SetRole>().AsQueryable();

				#region Filter
				Expression<Func<MIT.ECSR.Data.Model.SetRole, object>> column_sort = null;
				List<Expression<Func<MIT.ECSR.Data.Model.SetRole, bool>>> where = new List<Expression<Func<MIT.ECSR.Data.Model.SetRole, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<MIT.ECSR.Data.Model.SetRole, bool>> where, Expression<Func<MIT.ECSR.Data.Model.SetRole, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<MIT.ECSR.Data.Model.SetRole, object>> result_order = null;
			Expression<Func<MIT.ECSR.Data.Model.SetRole, bool>> result_where = null;
