...
namespace MIT.ECSR.Core.Role.Command
{
    ...
    public class AddRoleRequest :RoleRequest, IMapRequest<MIT.ECSR.Data.Model.SetRole, AddRoleRequest>,IRequest<StatusResponse>
    {
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<AddRoleRequest, MIT.ECSR.Data.Model.SetRole> map)
        {
    ...
    internal class AddRoleHandler : IRequestHandler<AddRoleRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddRoleRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<MIT.ECSR.Data.Model.SetRole>(request);
